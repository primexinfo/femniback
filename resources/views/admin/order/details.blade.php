                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        {{--<div class="col-lg-6">--}}
                                            {{--<div class="special-box">--}}
                                                ...
                                                {{--</div>--}}
                                                {{--<div class="table-responsive-sm">--}}
                                                    {{--<form action="{{route('admin-order-inventory')}}" method="post">--}}
                                                        {{--{{csrf_field()}}--}}
                                                        {{--<label for="">Select Inventory</label>--}}
                                                        {{--<select name="warehouse_id" id="">--}}
                                                            {{--<option value="">select</option>--}}
                                                            {{--@foreach($warehouses as $warehouse)--}}
                                                                {{--<option @if($order->warehouse_id == $warehouse->id) selected @endif value="{{$warehouse->id}}">{{$warehouse->name}}</option>--}}
                                                            {{--@endforeach--}}
                                                        {{--</select>--}}
                                                        {{--<input type="hidden" name="order_id" value="{{$order->id}}">--}}
                                                        {{--<button class="add-btn" href="">Submit</button>--}}
                                                    {{--</form>--}}
                                                {{--</div>--}}
                                            {{--</div>--}}
                                        {{--</div>--}}
                                                    ...
                                                    <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                        ...
                                                        @foreach($cart as $product)
                                                            <tr>
                                                                ...
                                                                <td><span style="width: 40px; height: 20px; display: block; background:{{$product['product_color']}};"></span></td>
                                                                <td>{{$order->currency_sign}} {{$product['total_price']}}</td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>

...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __("Packages") }}</h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }} </a>
                        </li>
                        <li>
                            <a href="javascript:;">{{ __("Packages") }} </a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="mr-table allproduct">
                        <div class="row">
                            ...
                            @if(Auth::guard('admin')->user()->role != 'posAdmin')
                                <a href="{{route('admin-prod-package-create')}}" class="add-btn"> Add package</a>
                            @endif
                        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#ajaxTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin-prod-package-datatable') }}',
            columns: [
                { data: 'name', name: 'name' },
                { data: 'type', name: 'type' },

                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-service-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <textarea class="input-field" name="sub_title" placeholder="{{ __('Sub Title') }}">{{ $data->sub_title }}</textarea> 
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea class="input-field nic-edit" name="details" placeholder="{{ __('Description') }}">{{ $data->details }}</textarea> 
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">

...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Package create') }} <i class="fas fa-arrow-left"></i> {{ __('Back') }}</h4>
                    <ul class="links">
                        <li>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="" action="{{route('admin-prod-store-package')}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading text-right">{{ __('Package Name') }}* </h4>
                                            <p class="sub-heading">(In Any Language)</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" placeholder="{{ __('Enter Package Name') }}" name="name" required="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="featured-keyword-area">
                                            <div class="feature-tag-top-filds" id="product_add">
                                                <div class="feature-area">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <input type="text" name="item_quantity[]" class="input-field">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

                                            <a href="javascript:;" id="product_add_button" class="add-fild-btn"><i class="icofont-plus"></i> {{ __('Add More Field') }}</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {{--<div class="col-lg-4">--}}
                                {{--<div class="left-area">--}}
                                {{--<h4 class="heading">{{ __("Pre-book") }}</h4>--}}
                                {{--</div>--}}
                                {{--</div>--}}
                                {{--<div class="col-lg-7">--}}
                                {{--<select id="" name="upcoming" >--}}
                                {{--<option value="">Select</option>--}}
                                ...
                                <div class="showbox">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="left-area">
                                                <h4 class="heading">{{ __('Package Estimated Shipping Time') }}* </h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-7">
                                    ...
                                    <div class="col-lg-7">
                                        <ul class="list">
                                            <li>
                                                ...
                                                <label for="size-check">{{ __('Allow Package Sizes') }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-7">
                                        <ul class="list">
                                            <li>
                                                ...
                                                <label for="check3">{{ __('Allow Package Colors') }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-7">
                                        <ul class="list">
                                            <li>
                                                ...
                                                <label for="whole_check">{{ __('Allow Package Whole Sell') }}</label>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Package Previous Price') }}*</h4>
                                ...
                                <div class="showbox">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="left-area">
                                                <h4 class="heading">{{ __('Package Measurement') }}*</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $("#uploadgallery").change(function(){
            ...
            for(var i=0;i<total_file;i++)
            {
                ...
                $('#ajaxform').append('<input type="hidden" name="galval[]" id="galval'+i+'" class="removegal" value="'+i+'">')
            }
    ...
    <script type="text/javascript">
        ...
        $("#product_add_button").click(function(e){
            ...
            if(x<max_fields) {
                x++;
                $('#product_add').append('<div class="feature-area">\n' +
                    '                                                    <span id="row_remove" class="remove"><i class="fas fa-times"></i></span>\n' +
                    '                                                    <div class="row">\n' +
                    '                                                        <div class="col-lg-8">\n' +
                    '                                                            <select id="" name="product_id[]" >\n' +
                    '                                                                <option value="">Select</option>\n' +
        ...
        $('#product_add').on("click","#row_remove", function(e){
            e.preventDefault();

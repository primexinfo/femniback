	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8 mt-3">
				...
				<form id="step1-form" action="{{route('amarpay.submit')}}" method="POST" class="checkoutform">
				<!-- {{--<form id="" action="{{route('amarpay.submit')}}" method="POST" class="checkoutform">--}} -->
							...
							<div class="tab-pane fade show active" id="pills-step1" role="tabpanel"
								...
								<div class="content-box">
									...
									<div class="content">
										...
										<div class="row">
											<div class="col-lg-12  mt-3">
												<div class="bottom-area float-right">
											...
											<div class="col-lg-12 mt-3">
												<div class="bottom-area float-right">
													<a href="javascript:;" id="step1-btn"
														class="mybtn1 mr-3 mb-3">{{ $langg->lang757 }}</a>
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="nav flex-column" role="tablist"
														...
														<a class="nav-link payment" data-show="no"
															data-form="{{route('amarpay.submit')}}"
															...
															<p>
																Digital Payment
																<small>
																	Pay via aamarPay payment gateway
																</small>
															</p>
														</a>
														@if($digital == 0)

														{{--@foreach($gateways as $gt)--}class="nav-link payment" data-show="yes"--}}

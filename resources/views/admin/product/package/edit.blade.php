                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="" action="{{route('admin-prod-package-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Package Name') }}* </h4>
                                            <p class="sub-heading">{{ __('(In Any Language)') }}</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" placeholder="{{ __('Enter Package Name') }}" name="name" required="" value="{{ $data->name }}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <table class="table table-bordeless">
                                                                ...
                                                                @php
                                                                    $items  = unserialize(bzdecompress(utf8_decode(($data->package_items))));
                                                                $n = 0;
                                                                @endphp
                                                                <tbody>
                                                                @if($items)@foreach($items as $item)
                                                                    <tr>
                                                                        <td>
                                                                            @php
                                                                                $product_name = \App\Models\Product::where('id',$item['id'])->first(['name'])
                                                                            @endphp

                                                                            {{$product_name->name}}
                                                                            <input type="hidden" name="product_id[]" class="input-field" value="{{$item['id']}}">
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="input-field" name="item_quantity[]" value="{{$item['item_quantity']}}">
                                                                        </td>
                                                                        <td>
                                                                            <button class="iTemButton add-btn" ><i class="fas fa-times"></i></button>
                                                                        </td>
                                ...
                                {{--<option value="">Select</option>--}}
                                {{--<option @if($data->upcoming == 1) selected @endif value="1">Yes</option>--}}
                                {{--<option @if($data->upcoming == 0) selected @endif value="0">No</option>--}}
                                {{--</select>--}}
                                {{--</div>--}}
                                {{--</div>--}}

...
@section('content')  
					<input type="hidden" id="headerdata" value="{{ __('Testimonial') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Testimonial') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-blog-index') }}">{{ __('Testimonial') }}</a>
											</li>
										</ul>
								</div>
							</div>

        ...
        <div class="invoice__metaInfo">
            <div class="col-lg-6">
                <div class="invoice__orderDetails">
                    ...
                    <span><strong>{{ __('Payment Status') }} :</strong>
                        {{ $order->payment_status == 'Pending' ? "Unpaid":"Paid" }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="invoice__metaInfo">
            <div class="col-lg-6">
                <div class="invoice__orderDetails">
                    ...
                    <span><strong>{{ __('Customer Name') }}</strong>: {{ $order->customer_phone}}</span><br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p>
                                            color : <span
                                                style="margin-left: 40px; width: 20px; height: 0.2px; display: block; border: 10px solid {{$product['color'] == "" ? "white" : $product['color']}};"></span>
                                        </p>
                                        @endif
                                        <p>
                                            Price :

                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-service-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                             <textarea  class="input-field" name="sub_title" placeholder="{{ __('Sub Title') }}"></textarea> 
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea  class="input-field nic-edit" name="details" placeholder="{{ __('Description') }}"></textarea> 
                          </div>
                        </div>

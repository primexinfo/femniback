...
@section('content')
                        ...
                        @include('includes.admin.form-error') 
											<form id="ajaxformdata" action="{{ route('admin-warehouse-store') }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}

												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															<h4 class="heading">{{ __('Warehouse type') }} *</h4>
														</div>
													</div>
													<div class="col-lg-7">
														<select name="warehouse_type" id="" required>
															<option value="warehouseAdmin">General Warehouse</option>
														</select>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="name" placeholder="{{ __("Warehouse Name") }}" required="" value="">
													</div>
												</div>
						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <button class="addProductSubmit-btn" type="submit">{{ __("Create warehouse") }}</button>
						                          </div>
						                        </div>
